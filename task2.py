...
#print(f'Число {num2} в {16} системе счисления будет: {res_str}')
#print(hex(num2))
...
#Nfr же наконспектировала и опробовала обратный перевод
...
# Решено совместно с коллегами конечно небольшое растройство что сама недогнала это
